                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="{{ route('datasatker') }}" method="get">
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="nama_satker_cari" id="nama_satker_cari"
                                                           class="form-control"
                                        ...
                                        @foreach($satker as $d)
                                            @php
                                                //Storage -> public : E:\LARAVEL\presensigps\storage\app
                                                    $path = Storage::url('uploads/satker/'.$d->foto);
                                            @endphp
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="{{ route('satkerdelete',$d->id) }}" method="post"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    {{--ASLIII--}}
                    <h5 class="modal-title">Tambah Data Satkerz</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('satkerstore') }}" method="post" id="tambahfrmSatker" name="tambahfrmSatker"
                            ...
                            <div class="col-12">
                                ...
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input type="text" readonly value="{{ $kode_satker }}" class="form-control"
                                           name="kode_satker" id="kode_satker"
                                ...
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input type="text" value="" class="form-control"
                                           name="nama_satker" id="nama_satker"
                                           placeholder="Nama Satkerz">
                                </div>
                            </div>
                        </div>
                        <div class="row">
