...
@section('content')
                                ...
                                <div class="col-3" style="margin-left: -80px">
                                    ...
                                    <a href="#" class="tampilkanlaporan_whatssap_message_today_kanwil btn btn-warning"
                                       kode_satker_value="{{ $satker->kode_satker }}" id="btnTambahBeritaSatker">
                                        ...
                                        @endphp
                                        {{--Proses Generate--}}
                                        Rekap Berita Hari Ini ({{ ucfirst($humas_kanwil[0])." ".ucfirst($humas_kanwil[1]) }})
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered"
                                        ...
                                        @foreach($berita_satker as $d)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        {{--edit disini--}}
                                                        <a href="#" class="pilih_konfigurasi_berita btn btn-warning btn-sm"
                                                           id_berita="{{ $d->id_berita }}" kode_satker="{{ $satker->kode_satker }}"
                                    ...
                                    <div class="input_fields_wrap_nasional">
                                        ...
                                        <table class="m-l-15 col-lg-12">
                                            <tr class="">
                                                ...
                                                <td class="" style="">
                                                    {{--<label for="">Berita Media Lokal</label>--}}
                                                    <input type="text" name="jumlah_nasional[]" class="form-control "
    ...
    <div class="modal modal-blur fade" id="pilih_konfigurasi_modal" name="pilih_konfigurasi_modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{--ASLIII--}}
                        ...
                        @endphp
                        Laporan Rekap Hari Ini <small>oleh {{ $satker->name }} ( {{ ucfirst($explode[0])." ".ucfirst($explode[1]) }} )</small>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal modal-blur fade" id="modal-tampilkandetail_whatssap" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            $(add_button).click(function (e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    $(wrapper).append('<div>' +
                        ...
                        '</td>' +
                        '<td style=""><input type="text" name="jumlah[]" class="form-control"  ' +
                        'placeholder="Judul Berita|||Link Media Lokal" >' +
                        '</td>' +
                        '</tr>' +
                        '</table>' +
            ...
            $(add_button_nasional).click(function (e) { //on add input button click
                ...
                if (x < max_fields_nasional) { //max input box allowed
                    ...
                    $(wrapper_nasional).append('<div>' +
                        ...
                        '</td>' +
                        '<td style=""><input type="text" name="jumlah_nasional[]" class="form-control"  ' +
                        'placeholder="Judul Berita|||Link Media Nasional" >' +
                        '</td>' +
                        '</tr>' +
                        '</table>' +
