...
<form action="{{ route('satkerupdate',$satker->id) }}" method="post" id="frmSatker" name="frmSatker"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $satker->kode_satker }}" class="form-control" name="kode_satker"
                       id="kode_satker"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $satker->name }}" class="form-control" name="nama_satker"
                       id="nama_satker"
    ...
    <div class="row ">
        <div class="col-12">
            ...
            <input type="hidden" name="old_foto" id="old_foto" value="{{ $satker->foto }}">
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-12">
